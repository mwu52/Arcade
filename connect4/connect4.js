...
const col0 = [cells[35], cells[28], cells[21], cells[14], cells[7], cells[0], topCells[0]];
const col1 = [cells[36], cells[29], cells[22], cells[15], cells[8], cells[1], topCells[1]];
const col2 = [cells[37], cells[30], cells[23], cells[16], cells[9], cells[2], topCells[2]];
const col3 = [cells[38], cells[31], cells[24], cells[17], cells[10], cells[3], topCells[3]];
const col4 = [cells[39], cells[32], cells[25], cells[18], cells[11], cells[4], topCells[4]];
const col5 = [cells[40], cells[33], cells[26], cells[19], cells[12], cells[5], topCells[5]];
const col6 = [cells[41], cells[34], cells[27], cells[20], cells[13], cells[6], topCells[6]];
...
const winCheck = (cells) => {
 ...
 = false;
  ...
  statusSpan.textContent = `${playerSwitch
? 'Yellow' : 'Red'} has won!`
  return true;
};

const gameStatusCheck = (cell) => {
...
const handleCellMouseOver = (e) => {
  ...
  const topCell = topCells[colIndex];
  topCell.classList.add(playerSwitch
? 'yellow' : 'red');
};
...
const handleCellClick = (e) => {
  ...
  openCell.classList.add(playerSwitch
? 'yellow' : 'red');
